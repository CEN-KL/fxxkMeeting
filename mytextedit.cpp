...
MyTextEdit::MyTextEdit(QWidget *par): QWidget(par)
{
...
QString MyTextEdit::toPlainTextEdit()
{
    return edit->toPlainText();
}

void MyTextEdit::setPlainTextEdit(QString str)
{
...
{
    if (obj != edit) return QWidget::eventFilter(obj, event);
